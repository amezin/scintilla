...
push: fetch-upstream
	git push --force origin refs/remotes/upstream/branches/default/tip:upstream
...
git-cinnabar.linux.x86_64.tar.xz:
	wget https://github.com/glandium/git-cinnabar/releases/download/0.5.2/git-cinnabar.linux.x86_64.tar.xz -O $@
